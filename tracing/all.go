...
type Config struct {
	...
	*/
	...
	Host string `yaml:"host" validate:"hostname_rfc1123,required_if=Protocol oneof=udp UDP"`
	...
	Port string `yaml:"port" validate:"gte=0,lte=65535,required_if=Protocol oneof=udp UDP"`
	...
	*/
	...
	Endpoint string `yaml:"endpoint" validate:"url,required_if=Protocol oneof=http HTTP"`
